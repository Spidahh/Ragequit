...
export const DEFAULT_KEYBINDS: Record<KeybindAction, KeybindDef> = {
  ...
  transferHpMana: { action: 'transferHpMana', label: 'HP to Mana', code: 'KeyZ' },
  transferManaStam: { action: 'transferManaStam', label: 'Mana to Stamina', code: 'KeyX' },
  transferStamHp: { action: 'transferStamHp', label: 'Stamina to HP', code: 'KeyF' },
